...
public class Raamatupood {
	...
	public static void main(String[] args) {
		Raamatupood poodTool = new Raamatupood();
		poodTool.run();
	}
	...
	private Tellimus createTellimus() {
		...
		tellimus.addTellimuseRida(new TellimuseRida(new Toode(1, "Neverland", new BigDecimal(8.11)), 2));
		tellimus.addTellimuseRida(new TellimuseRida(new Toode(1, "Laulud või nii", new BigDecimal(15.33)), 1));
